        ...
        public static void SeedReports(IM_API_Context context)
        {
            ...
            var reports = new Report[]
            {
                ...
                new Report
                {
                    ...
                    Query = "SELECT TRIM(CONCAT(StudentFirstName, ' ', StudentLastName)) as name, SUM(WeightedScore) AS value, Observations.StudentID as id FROM Observations {joinAndWhere} AND WeightedScore != 0 GROUP BY name, id",
                    Axis1Name = "Student",
                    Axis2Name = "Total Observation Severity",
                    AvailableChartTypes = "Bar,Pie,BubbleCloud"
                },
